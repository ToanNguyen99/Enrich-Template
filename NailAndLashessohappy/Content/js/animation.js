$(document).ready(function () {
    ...
    function Menu_mlick1() {
        $(".menu_m").stop(true, true).animate({ height: "290px" }, 400);
        playmenu = "0";
    }
    ...
    $(window).resize(function () {
        ...
        if (width > 800) {
            $(".menu_m").stop(true, true).css({ height: "auto" });
            playmenu = '0';
        }
    });
...
function myNavFunc() {
    ...
    if (iOS) {
        window.open("http://maps.apple.com/?q=2704421180");
    }
    else {
        window.open("http://maps.google.com/?q=Queen+Nail+Spa+5134+Hinkleville+Road+C+Paducah+Kentucky+42001");
    }
} 